      ...
      <div className="grid grid-cols-3 gap-2">
        {categories.map(({ id, name }) => (
          <button
            ...
            className={`w-full px-2 py-3 rounded-lg text-xs sm:text-sm font-bold transition-all transform focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
              categoriasActivas[id]
